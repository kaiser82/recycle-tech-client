            ...
            <div className="hero py-5 ">
                <div className="hero-content flex-col lg:flex-row-reverse">
                    ...
                    <div className='w-full text-center lg:text-left'>
                        ...
                        <p className="text-xl py-6">Its easy to buy or sell your old laptop online. <br /> You will get world best deals from here. <br /> Join us today and enjoy the ride.</p>
